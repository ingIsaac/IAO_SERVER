...
void LuaScriptInterface::registerFunctions()
{
	...
	registerMethod("Player", "setPlayerTargetCancel", LuaScriptInterface::luaPlayerSetTargetCancel);
	...
	registerMethod("Monster", "getSkull", LuaScriptInterface::luaMonsterGetSkull);
...
int32_t LuaScriptInterface::luaPlayerSetTargetCancel(lua_State* L)
{
	// player:getDeathPenalty()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int32_t LuaScriptInterface::luaMonsterGetSkull(lua_State* L)
{
	// monster:getSkull()
	Monster* monster = getUserdata<Monster>(L, 1);
	if (monster) {
		lua_pushnumber(L, monster->getMonsterSkull());
	}
	else {
		lua_pushnil(L);
	}
